...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_post_create_new_question(self):
        res = self.client().post('/questions', json={'question': 'who is mr won', 'answer':'mr win','difficulty':2, 'category':2})
        data = json.loads(res.data)
    ...
    def test_400_if_question_creation_data_are_not_provided(self):
    ...
    def test_405_if_question_creation_not_allowed(self):
        res = self.client().post('/questions/56', json={'question': 'How is life', 'answer':'good','difficulty':2, 'category':2})
        data = json.loads(res.data)
    ...
    def test_get_questions_without_result(self):
        res = self.client().post('/questions/search', json={'searchTerm': 'opop ghghghghg'})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
    ...
    def test_404_questions_by_categories_not_found(self):
    ...
    def test_400_data_not_provided(self):
